...
// 아이템 평균 레벨을 사이드바에 출력 アイテムの平均レベルをサイドバーに出力
function getItemLv() {
...
// 선택된 아이템의 총 능력치를 사이드바에 출력　選択したアイテムのステータスをサイドバーに出力
...
// 선택된 아이템의 아이콘을 가져옴　選択したアイテムのアイコンを出力
...
//　選択したアイテムの装着可能なマテリア数に合わせてマテリア選択ウィンドウ生成
...
// 선택된 마테리아의 스탯을 더해서 출력해주는 함수　選択したマテリアのステータスを足してサイドバーに出力
