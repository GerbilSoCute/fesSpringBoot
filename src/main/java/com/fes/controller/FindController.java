...
import com.fes.entity.PageMaker;
...
public class FindController {
	...
	@GetMapping("/itemList")
	public String getItemCategory(@Param("category3")String category3, @Param("category2")String category2, @Param("cri")Criteria cri, Model model) {
